...
function OptionDivertissements() {
    const navigate = useNavigate();
    const apiUrl = 'https://okazy-production.up.railway.app/optiondivertissements';
      ...
      <form onSubmit={handleSubmit}>
        <div className="formbold-input-wrapp formbold-mb-3">
          ...
          <input
            ...
            placeholder="Option Divertissement"
            value={nom}
...
export default OptionDivertissements
