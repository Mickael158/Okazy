...
function SystemeDirection() {
    const navigate = useNavigate();
    const apiUrl = 'https://okazy-production.up.railway.app/systemdirections';
          ...
          <form onSubmit={handleSubmit}>
            <div className="formbold-input-wrapp formbold-mb-3">
              ...
              <input
                ...
                placeholder="Systeme Directionel"
                value={nom}
...
export default SystemeDirection
