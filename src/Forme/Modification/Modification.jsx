...
import BoiteM from './Boite/BoiteM';
import CassisM from './Cassis/CassisM';
import MarqueM from './Marque/MarqueM';
import ModelM from './Modele/ModelM';
import OptionDivertissementM from './OptionDivertissement/OptionDivertissementM';
import OptionSecuriteM from './OptionSecurite/OptionSecuriteM';
import SourceEnergieM from './SourceEnergie/SourceEnergieM';
import SuspensionM from './Suspension/SuspensionM';
import SystemeDirectionM from './SystemeDirection/SystemeDirectionM';
import SystemeFreinageM from './SystemeFreinage/SystemeFreinageM';
import VoitureM from './Voiture/VoitureM';
...
function Modification() {
  ...
  return <>
      ...
      <span onClick={()=>{
       ...
       <span onClick={()=>{
        ...
        <span onClick={()=>{
            ...
            <div className="card">
            <div>
                <div className="name">Annonce</div>
            </div>
    ...
    {insert === 2 && <MarqueM/>}
    {insert === 3 && <ModelM/>}
    {insert === 4 && <OptionDivertissementM/>}
    {insert === 5 && <OptionSecuriteM/>}
   {insert === 6 && <SourceEnergieM/>}
    {insert === 7 && <SuspensionM/>}
   {insert === 8 && <SystemeDirectionM/>}
    {insert === 9 && <SystemeFreinageM/>}
     {insert === 10 && <VoitureM/>}
     {insert === 11 && <Annonce/>}
